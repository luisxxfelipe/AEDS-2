...
int main()
{
    ...
    do
    {
        printf("\n[1] Ordenacao Quicksort.\n[2] Ordenacao Selectsort.\n[3] Ordenacao Insertsort\n[4] Ordenacao Mergesort\n");
        ...
        if (opcao == 1)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                fprintf(pont_arq, "\nOrdenacao Quicksort - [%d ORDENACAO] - Foram feitos um total de [%d] comparacoes durante a ordenacao, por (%f) segundos.\n", i, comparacoes, fim_do_processo / (float)CLOCKS_PER_SEC);
        ...
        if (opcao == 2)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                fprintf(pont_arq, "\nOrdenacao Selectsort - [%d ORDENACAO] - Foram feitos um total de [%d] comparacoes durante a ordenacao, por (%f) segundos.\n", i, comparacoes, fim_do_processo / (float)CLOCKS_PER_SEC);
                system("pause");
                printf("\n");
                system("cls");
            }
        ...
        if (opcao == 3)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                fprintf(pont_arq, "\nOrdenacao Insertsort - [%d ORDENACAO] - Foram feitos um total de [%d] comparacoes durante a ordenacao, por (%f) segundos.\n", i, comparacoes, fim_do_processo / (float)CLOCKS_PER_SEC);
                system("pause");
                printf("\n");
                system("cls");
            }
        ...
        if (opcao == 4)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                fprintf(pont_arq, "\nOrdenacao Mergesort - [%d ORDENACAO] - Foram feitos um total de [%d] comparacoes durante a ordenacao, por (%f) segundos.\n", i, comparacoes, fim_do_processo / (float)CLOCKS_PER_SEC);
                system("pause");
                printf("\n");
                system("cls");
            }
